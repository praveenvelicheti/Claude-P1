...
export function Modal({ open, onClose, title, subtitle, children, footer }: ModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[500] flex items-center justify-center bg-ink/45 backdrop-blur-sm"
      onClick={(e) => { if (e.target === e.currentTarget) onClose() }}
    >
      <div
        className="bg-white rounded-[18px] p-9 w-[480px] max-w-[95vw] shadow-[0_24px_64px_rgba(26,58,58,0.2)] animate-[modalIn_0.25s_cubic-bezier(0.34,1.56,0.64,1)]"
