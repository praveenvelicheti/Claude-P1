      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[400px]">
          ...
          <div className="flex flex-col gap-3 mb-6">
            ...
            <button
              type="button"
              onClick={async () => { try { await signInWithApple() } catch (err) { setError(err instanceof Error ? err.message : 'Apple sign-in failed') } }}
              className="w-full flex items-center justify-center gap-3 py-[10px] px-4 border border-border rounded-[9px] bg-ink hover:bg-[#0e2828] transition-all text-[13.5px] font-medium text-white cursor-pointer"
            >
